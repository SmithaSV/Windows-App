...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Label2.Location = New Point(124, 67)
        Label2.Name = "Label2"
        ...
        Label6.Location = New Point(124, 339)
        Label6.Name = "Label6"
        ...
        TextBox2.Location = New Point(309, 124)
        TextBox2.Name = "TextBox2"
        TextBox2.ReadOnly = True
        TextBox2.Size = New Size(400, 30)
        TextBox2.TabIndex = 7
        TextBox2.Text = "johndoe45@gmail.com"
        TextBox2.TextAlign = HorizontalAlignment.Center
        ' 
        ' TextBox3
        ' 
        TextBox3.Font = New Font("Times New Roman", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        TextBox3.Location = New Point(309, 194)
        TextBox3.Name = "TextBox3"
        TextBox3.ReadOnly = True
        TextBox3.Size = New Size(400, 30)
        TextBox3.TabIndex = 8
        TextBox3.Text = "9832567509"
        TextBox3.TextAlign = HorizontalAlignment.Center
        ' 
        ' TextBox4
        ' 
        TextBox4.Font = New Font("Times New Roman", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        TextBox4.Location = New Point(309, 265)
        TextBox4.Name = "TextBox4"
        TextBox4.ReadOnly = True
        TextBox4.Size = New Size(400, 30)
        TextBox4.TabIndex = 9
        TextBox4.Text = "https://github/john_doe/my_slidely_task/"
        ...
        Button1.Location = New Point(124, 390)
        ...
        Button2.Font = New Font("Times New Roman", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Button2.ForeColor = Color.FromArgb(CByte(0), CByte(0), CByte(192))
        Button2.Location = New Point(479, 390)
        ...
        ' TextBox5
        ' 
        TextBox5.Font = New Font("Times New Roman", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        TextBox5.Location = New Point(309, 334)
        ...
        Button5.Font = New Font("Times New Roman", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Button5.ForeColor = Color.FromArgb(CByte(0), CByte(0), CByte(192))
        Button5.Location = New Point(479, 443)
        Button5.Name = "Button5"
        Button5.Size = New Size(230, 29)
        Button5.TabIndex = 16
        Button5.Text = "EDIT ( CTRL + E )"
        Button5.UseVisualStyleBackColor = False
        ' 
        ' Button3
        ' 
        Button3.BackColor = Color.FromArgb(CByte(255), CByte(255), CByte(192))
        Button3.Font = New Font("Times New Roman", 12.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Button3.ForeColor = Color.FromArgb(CByte(0), CByte(0), CByte(192))
        Button3.Location = New Point(124, 443)
        Button3.Name = "Button3"
        Button3.Size = New Size(258, 29)
        Button3.TabIndex = 17
        Button3.Text = "DELETE FORM"
